...
class ExtGeneralDash {

  async getselectdash (us) {
    const response = await axios.get(`${URL}/extapprovals/getselectdash/${us}`, config.configWithToken())
...
export default new ExtGeneralDash()
