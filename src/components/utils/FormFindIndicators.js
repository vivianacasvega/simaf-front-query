...
const FormFindIndicators = (props) => {
        ...
        <Row className="mb-4">
          ...
          <Col sm={6} className="col-xl">
            <FormGroup className="mb-3">
              ...
              <select className="form-control select2-search-disable" value={selectFrente}
                onChange={(e) => {
                  setselectFrente(e.target.value);
                }}>
...
export default FormFindIndicators;
